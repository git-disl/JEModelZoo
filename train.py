...
print('double weight:', opts.double_weight)

triplet_loss = TripletLoss(device, gama=opts.gama, margin=opts.margin)
cls_triplet_loss = TripletLoss(device, gama=opts.gama, margin=opts.margin)
